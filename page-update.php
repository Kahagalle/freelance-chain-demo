...
<div class="row">
    ...
    <div class="col-sm-8">
        ...
        <form class="form-horizontal" method="post" enctype="multipart/form-data"
            ...
            <div class="form-group">
                <label for="upload" class="col-sm-2 control-label">Update file:<br/><span
            ...
            for ($index = 0; $index < const_update_custom_fields; $index++) {
                ...
                <div class="form-group">
                    <label for="key<?php echo $index ?>"
                           class="col-sm-2 control-label"><?php echo $index ? '' : 'Update fields:' ?></label>
                    <div class="col-sm-3">
                        <input class="form-control input-sm" name="key<?php echo $index ?>" id="key<?php echo $index ?>"
                               placeholder="key">
                    </div>
                    <div class="col-sm-6">
                        <input class="form-control input-sm" name="value<?php echo $index ?>"
                               id="value<?php echo $index ?>" placeholder="value">
                    </div>
                </div>
                <?php
            }
